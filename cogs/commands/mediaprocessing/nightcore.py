...
class NightcoreCog(commands.Cog):
    ...
    def create_nightcore(self, input_audio_path, output_audio_path):
        try:
    ...
    async def nightcore_command(self, interaction: nextcord.Interaction, song: nextcord.Attachment):
        ...
        try:
            ...
            success, result_path = self.create_nightcore(audio_path, output_path)
