...
class SetNickCog(commands.Cog):
    ...
    async def setnick(
        ...
        if member.top_role >= interaction.guild.me.top_role:
            await interaction.send(
                "❌ I can't change this user's nickname due to role hierarchy.",
                ephemeral=True
            )
            return
        ...
        try:
            ...
            embed = nextcord.Embed(
                ...
                description=f"Changed nickname of {member.mention} to **{nickname}**.",
